...
import { DelegatedTransferDetails, Offer, Public, SignedDelegatedTransferDetails, SignedOffer, TokenBalance, TokenId, TokenTransferDetails, TransferDetails, TransferStatus } from 'sample-polkadotjs-typegen/interfaces/default';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Option<SignedOffer>': Option<SignedOffer>;
    'Vec<SignedOffer>': Vec<SignedOffer>;
    TransferDetails: TransferDetails;
    'Option<TransferDetails>': Option<TransferDetails>;
    'Vec<TransferDetails>': Vec<TransferDetails>;
    TokenTransferDetails: TokenTransferDetails;
    'Option<TokenTransferDetails>': Option<TokenTransferDetails>;
    'Vec<TokenTransferDetails>': Vec<TokenTransferDetails>;
    TransferStatus: TransferStatus;
    'Option<TransferStatus>': Option<TransferStatus>;
    'Vec<TransferStatus>': Vec<TransferStatus>;
    DelegatedTransferDetails: DelegatedTransferDetails;
    'Option<DelegatedTransferDetails>': Option<DelegatedTransferDetails>;
    'Vec<DelegatedTransferDetails>': Vec<DelegatedTransferDetails>;
    SignedDelegatedTransferDetails: SignedDelegatedTransferDetails;
    'Option<SignedDelegatedTransferDetails>': Option<SignedDelegatedTransferDetails>;
    'Vec<SignedDelegatedTransferDetails>': Vec<SignedDelegatedTransferDetails>;
  }
}
